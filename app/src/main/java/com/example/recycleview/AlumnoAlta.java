            ...
            public void onClick(View v) {
                if(alumno == null){
                    ...
                    if(imgURI != null){
                        ...
                        alumno.setImgURI("android.resource://com.example.recycleview/" + R.drawable.agregar_alumno);
                    }
                    alumno.setMatricula(txtMatricula.getText().toString());
                    alumno.setNombre(txtNombre.getText().toString());
                    alumno.setCarrera(txtGrado.getText().toString());
                    //lblFoto.setText("Url de la foto: " +imgURI.toString());
                    ...
                    if(validar()){
                        ...
                        Toast.makeText(AlumnoAlta.this, "Faltó capturar datos", Toast.LENGTH_SHORT).show();
                ...
                if(posicion >= 0){
                    ...
                    if(txtMatricula.getText().toString().matches("")){
                        Toast.makeText(AlumnoAlta.this, "Ingrese su matricula", Toast.LENGTH_SHORT).show();
                    }
                    else if(txtNombre.getText().toString().matches("")){
                        Toast.makeText(AlumnoAlta.this, "Ingrese su nombre", Toast.LENGTH_SHORT).show();
                    }
                    else if(txtGrado.getText().toString().matches("")){
                        Toast.makeText(AlumnoAlta.this, "Ingrese su licenciatura o grado", Toast.LENGTH_SHORT).show();
                    }
                    else{
                        alumno.setMatricula(txtMatricula.getText().toString());
                        alumno.setNombre(txtNombre.getText().toString());
                        ...
                        db.closeDataBase();
                        Toast.makeText(AlumnoAlta.this, "Operación exitosa", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
            }
        ...
        btnBorrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(posicion >= 0){
                    new AlertDialog.Builder(AlumnoAlta.this)
                            ...
                            .setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Toast.makeText(AlumnoAlta.this, "Se ha eliminado con exito", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                            })
                    ...
                    Toast.makeText(AlumnoAlta.this, "El registro no existe", Toast.LENGTH_SHORT).show();
                }
            }
        });
