...
public class AlumnoDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ALUMNO = "CREATE_TABLE " +
    ...
    public static final String SQL_DELETE_ALUMNO = "DROP TABLE IF EXISTS " +
            DefineTabla.Alumnos.TABLE_NAME;

    public static final String DATABASE_NAME = "sistema.db";
    public static final int DATABASE_VERCION = 1;
